  ...
  return (
    <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'center' }}>
      ...
      <div className="animate-fade-in" style={{ textAlign: 'center', marginBottom: '40px' }}>
        ...
        <h1 style={{ fontSize: '1.75rem', fontWeight: 700, margin: 0 }}>RuralCareX</h1>
        <p style={{ color: 'var(--text-secondary)', marginTop: '8px' }}>Your rural health companion</p>
      </div>
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div>
            <label style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', marginBottom: '8px', display: 'block' }}>
              Aadhaar or Phone Number
            </label>
            <input 
              type="text"
              placeholder="Enter 10 or 12 digit number"
              value={identifier}
      ...
      <div style={{ textAlign: 'center', marginTop: '24px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
        ...
        <Link to="/doctor-login" style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', textDecoration: 'none' }}>
          Are you a doctor? <span style={{ color: 'var(--primary)' }}>Login here</span>
        </Link>
      </div>
